...
public class DownStreamService {
    ...
    private static Service lookupServiceDomainToService(String lookupDomain)
    ...
    public static void loadConfig(String proxyName) throws LoadingException {
        ...
        LOGGER.log(Level.ERROR, "execution path ", JAR_PATH);
    ...
    private CloseableHttpResponse executeRequest(
        ...
        // don't  close httpClient because httpResponse refer to it
        CloseableHttpResponse httpResponse = null;

        HttpEntity entity = new ByteArrayEntity(body.getBytes(StandardCharsets.UTF_8));
        LOGGER.log(Level.INFO, "calling service: ", uri);
        try {
    ...
    private ResponseObject callTheService(
        ...
        try {
            ...
            LOGGER.log(Level.ERROR, "errror calling the service: ", e);
            responseO.body = e.getMessage();
