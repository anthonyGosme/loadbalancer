...
class ProxyServiceTest {
    ...
    void lookup_ServiceName_To_IdService() throws LoadingException {
            ...
            assertEquals("my-service", Objects.requireNonNull(lookupServiceNameToService("my-service")).getName());
            assertEquals("my-service2", Objects.requireNonNull(lookupServiceNameToService("my-service2")).getName());
    ...
    void getRandomHost() throws LoadingException {
            ...
            assertEquals(
                    9090,
                    Objects.requireNonNull(DownStreamService.getRandomHost(lookupServiceNameToService("my-service"))).getPort());

            assertEquals(
                    9092,
                    Objects.requireNonNull(DownStreamService.getRandomHost(lookupServiceNameToService("my-service2"))).getPort());
